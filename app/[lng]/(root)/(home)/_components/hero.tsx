...
const Hero = () => {
  ...
  return (
    <>
      <div className='container mx-auto grid min-h-[80vh] max-w-6xl grid-cols-2 gap-8 max-md:grid-cols-1 max-md:pt-32 max-md:px-4'>
        <div className='flex-col flex space-y-4 self-center'>
